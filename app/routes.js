...
// Triage form v3
router.post('/feature/triage-form/v3/check-your-answers/action', function (req, res) {
    var source = req.session.data['source']

    if (source == "ucas") {
        res.redirect('/feature/triage-form/v3/check-your-answers-ucas')
    }
    else {
        res.redirect('/feature/triage-form/v3/check-your-answers')
    }
})

// Triage form v4
router.post('/feature/triage-form/v4/check-your-answers/action', function (req, res) {
    var source = req.session.data['source']

    if (source == "ucas") {
        res.redirect('/feature/triage-form/v4/check-your-answers-ucas')
    }
    else {
        res.redirect('/feature/triage-form/v4/check-your-answers')
    }
})
...
// Triage form v6
router.post('/feature/triage-form/v6/check-your-answers/action', function (req, res) {
    var source = req.session.data['source']

    if (source == "ucas") {
        res.redirect('/feature/triage-form/v6/check-your-answers-ucas')
    }
    else {
        res.redirect('/feature/triage-form/v6/check-your-answers')
    }
})
